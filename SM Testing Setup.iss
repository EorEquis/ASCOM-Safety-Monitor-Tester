...
; Generated by EoEquis on 1/15/2024 (UTC)
;
[Setup]
AppID={{b77a55fe-80b3-4b89-b628-cfe1ef3cd4e6}
AppName=ASCOM Testing SafetyMonitor Driver
AppVerName=ASCOM Testing SafetyMonitor Driver 2.0.0.0
AppVersion=2.0.0.0
...
OutputDir="."
OutputBaseFilename="ASCOM_SafetyMonitor_Driver_Testing_Setup_V2.0.0.0"
Compression=lzma
...
[Files]
Source: "G:\Dev\Git\ASCOM Safety Monitor Tester\bin\Release\ASCOM.TSO.exe"; DestDir: "{app}"
; TODO: Add driver assemblies into the ServedClasses folder
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "G:\Dev\Git\ASCOM Safety Monitor Tester\README.txt"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{app}\ASCOM.TSO.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.TSO.exe"; Parameters: "/unregister"
