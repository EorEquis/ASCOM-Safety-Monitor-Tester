...
//
// ASCOM SafetyMonitor hardware class for TSO
//
...
namespace ASCOM.TSO.SafetyMonitor
{
    ...
    internal static class SafetyMonitorHardware
    {
        ...
        internal const string filePathProfileName = "File Path";
        internal const string filePathDefault = "C:\\SMTFile\\";
        ...
        static SafetyMonitorHardware()
        {
            try
            {
                ...
                tl = new TraceLogger("", "TSO.Hardware");
        ...
        public static bool IsSafe
        {
            get
            {
                if (File.Exists(filePath + "isSafe"))
                {
        ...
        internal static void ReadProfile()
        {
            using (Profile driverProfile = new Profile())
            {
                ...
                filePath = driverProfile.GetValue(DriverProgId, filePathProfileName, string.Empty, filePathDefault);
            }
        }
        ...
        internal static void WriteProfile()
        {
            using (Profile driverProfile = new Profile())
            {
                ...
                driverProfile.WriteValue(DriverProgId, filePathProfileName, filePath);
            }
        }
