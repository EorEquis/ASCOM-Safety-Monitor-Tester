...
//
// ASCOM SafetyMonitor driver for TSO
//
...
namespace ASCOM.TSO.SafetyMonitor
{
    ...
    //
    // Your driver's DeviceID is ASCOM.TSO.SafetyMonitor
    //
    // The COM Guid attribute sets the CLSID for ASCOM.TSO.SafetyMonitor
    // The COM ClassInterface/None attribute prevents an empty interface called _TSO from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("6eaf459c-68be-408c-a253-e2471b1e502f")]
    [ProgId("ASCOM.Test.SafetyMonitor")]
    [ServedClassName("ASCOM SafetyMonitor Test Driver")] // Driver description that appears in the Chooser, customise as required
    ...
    public class SafetyMonitor : ReferenceCountedObjectBase, ISafetyMonitor, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TSO"/> class. Must be public to successfully register for COM.
        /// </summary>
        public SafetyMonitor()
        {
            try
            {
                ...
                tl = new TraceLogger("", "TSO.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.TSO.SafetyMonitor", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
