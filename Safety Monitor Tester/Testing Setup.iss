...
;
[Setup]
AppID={{e9375433-c719-4427-a122-7eb82e47625b}
...
Source: "G:\Dev\Git\Safety Monitor Tester\Safety Monitor Tester\bin\Release\Safety Monitor Tester.dll"; DestDir: "{app}" ;AfterInstall: RegASCOM(); Flags: regserver
...
begin
   ...
   P.Register('Testing.SafetyMonitor', 'Safety Monitor Tester');
end;
...
begin
   ...
   begin
     P := CreateOleObject('ASCOM.Utilities.Profile');
     P.DeviceType := 'SafetyMonitor';
     P.Unregister('Testing.SafetyMonitor');
  end;
end;
